                     ...
                     .filter((obj) => obj.price.includes(filterPrice)).map((item, index) => {
                        ...
                        return (
                            <div onClick={()=> window.location.href = `/productinfo/${id}`}   key={index} className="p-4 md:w-1/4  drop-shadow-lg " >
                                <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-2xl overflow-hidden" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                    ...
                                    <div className="p-5 border-t-2">
                                        ...
                                        <div className=" flex justify-center">
                                            ...
                                            className="focus:outline-none text-white bg-black hover:scale-105 duration-300 focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm w-full  py-2">Add To Cart</button>
