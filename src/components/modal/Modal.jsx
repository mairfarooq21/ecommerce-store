...
export default function Modal({ name, address, pincode, phoneNumber, setName, setAddress, setPincode, setPhoneNumber, buyNow }) {
    ...
    return (
        <>
            <div className="  text-center rounded-lg text-white font-bold" style={{ fontFamily: 'Poppins, sans-serif' }}>
                <button
                    type="button"
                    onClick={openModal}
                    className="w-full  bg-black hover:scale-105 duration-300 py-2 text-center rounded-full text-white font-medium ">
                    Buy Now
                </button>
            </div>
                                        ...
                                        <div className="flex flex-col items-center justify-center py-8 mx-auto  lg:py-0">
                                            ...
                                            <div className="w-full  rounded-lg md:mt-0 sm:max-w-md xl:p-0 ">
                                                ...
                                                <form className="space-y-4 md:space-y-6" action="#">
                                                    ...
                                                    <button onClick={()=>{buyNow(); closeModal()}} type="button" className="focus:outline-none w-full text-white bg-black hover:scale-105 duration-300  outline-0 font-medium rounded-full text-sm px-5 py-2.5 ">Order Now</button>
